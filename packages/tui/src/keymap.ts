...
export const KEYMAP: readonly KeymapEntry[] = [
  ...
  { keys: "] / L", description: "next loop scope", scope: "global" },
  { keys: "[", description: "previous loop scope", scope: "global" },
  { keys: "r", description: "refresh snapshot", scope: "global" },
  { keys: "s", description: "start the scoped loop", scope: "global" },
  { keys: "S", description: "stop the scoped loop", scope: "global" },
  { keys: "p", description: "pause / resume the scoped loop", scope: "global" },
  { keys: "t", description: "tick the scoped loop", scope: "global" },
...
export const HELP_ENTRIES: ReadonlyArray<readonly [string, string]> = [
  ...
  ["[ / ] or L", "previous / next loop scope"],
  ["r", "refresh snapshot"],
  ["s / S", "start / stop the scoped loop"],
  ["p / t", "pause-resume / tick the scoped loop"],
